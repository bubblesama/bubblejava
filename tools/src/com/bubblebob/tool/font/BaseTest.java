...
public class BaseTest extends BaseText implements GameModel, GraphicalModel {
	...
	public static void main(String[] args) {
		BaseTest test = new BaseTest("Heureux qui comme Ulysse a fait un beau voyage, ou comme cestui la qui conquit la Toison", BaseFont.getZoomedFont("assets/alphabet.png",2), 10, 10, 10,100, 3);
		int frameDelay = 25;
