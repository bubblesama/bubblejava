...
public class SimpleMovement {
	...
	public static SimpleMovement getSimpleMovement(Direction direction){
		...
		case NORTH:
		case SOUTH:
			return new SimpleMovement(direction,0,DdConstants.TILE_HEIGHT_DEPRECATED,0,0,ticksToMove,0,0,DdConstants.STEP_Y_DEPRECATED);
		case EAST:
		case WEST:
			return new SimpleMovement(direction,DdConstants.TILE_WIDTH_DEPRECATED,0,0,0,ticksToMove,0,DdConstants.STEP_X_DEPRECATED,0);
		case NONE:
		...
		case SOUTH_WEST:
		case NORTH_WEST:
			return new SimpleMovement(direction,DdConstants.TILE_WIDTH_DEPRECATED,DdConstants.TILE_HEIGHT_DEPRECATED,0,0,ticksToMove,0,DdConstants.STEP_X_DEPRECATED,DdConstants.STEP_Y_DEPRECATED);
		default:
			return null;
		}
	}
	...
	public static SimpleMovement getSimpleMovement(Direction direction, int ticksToMove, int dX, int dY){
		...
		case NORTH:
		case SOUTH:
			return new SimpleMovement(direction,0,DdConstants.TILE_HEIGHT_DEPRECATED,0,0,ticksToMove,0,dX,dY);
		case EAST:
		case WEST:
			return new SimpleMovement(direction,DdConstants.TILE_WIDTH_DEPRECATED,0,0,0,ticksToMove,0,dX,0);
		case NONE:
			return new SimpleMovement(direction,0,0,0,0,ticksToMove,0,0,0);
		case NORTH_EAST:
		case SOUTH_EAST:
		case SOUTH_WEST:
		case NORTH_WEST:
			return new SimpleMovement(direction,DdConstants.TILE_WIDTH_DEPRECATED,DdConstants.TILE_HEIGHT_DEPRECATED,0,0,ticksToMove,0,dX,dY);
		default:
			return null;
		}
	}
