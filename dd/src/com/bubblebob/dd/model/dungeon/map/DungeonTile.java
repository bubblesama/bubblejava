...
public class DungeonTile implements Serializable{
	...
	public DungeonTile(DungeonTile seed){
		this.i = seed.i;
		this.j = seed.j;
		this.type = seed.type;
	...
	public DungeonTile(int i, int j, DungeonTileType type){
		this.i = i;
		this.j = j;
		this.type = type;
		this.items = new Vector<Item>();
	...
	public DungeonTileType getType(){
		return type;
	}
	
	public void setType(DungeonTileType type){
		this.type = type;
	}
