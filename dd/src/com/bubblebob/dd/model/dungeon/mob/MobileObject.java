...
public abstract class MobileObject {
	...
	private SimpleMovement nextMovement(){
		...
		result = nextMovement(x/model.getTileWidth(), y/model.getTileHeight(), direction, ticksToMove, DdConstants.STEP_X_DEPRECATED, DdConstants.STEP_Y_DEPRECATED);
...
//		System.out.println("MobileObject.move: dX="+dX+" dY="+dY);
